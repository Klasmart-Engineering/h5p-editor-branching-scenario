...
export default class EditorOverlay extends React.Component {
  ...
  ready = () => {
    ...
    if (fm) {
      fm.on('formopened', e => {
        ...
        if (library === "H5P.CoursePresentation" || library === "H5P.CoursePresentationKID" || library === "H5P.InteractiveVideo" ) {
  ...
  modifyRequiresFinishingField(library = {}) {
    ...
    if (machineName === 'H5P.CoursePresentation' || machineName === 'H5P.CoursePresentationKID') {
